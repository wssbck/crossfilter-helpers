...
describe('Reduce by spread', function() {
	...
	describe('calculates reduction values correctly using arbitrary precision arithmetic', function() {
        ...
        it('whole dataset to 400', function() {
            reduceVal = reduceAcc( reduceAll.value() );
            expect(reduceVal).toBe(400);
        });

        it('group A to 400', function() {
		 	dimf.filter('A');
	...
	describe('also when a dimension is filtered', function() {
        ...
        it('whole dataset reduced to 212.15', function() {
            reduceVal = reduceAcc( reduceAll.value() );
            expect(reduceVal).toBe(212.15);
        });
